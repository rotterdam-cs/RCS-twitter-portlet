...
/**
 * Provides the local service interface for TwitterSettings. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rcs
 * @see TwitterSettingsLocalServiceUtil
...
public interface TwitterSettingsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TwitterSettingsLocalServiceUtil} to access the twitter settings local service. Add custom service methods to {@link com.rcs.dbservice.service.impl.TwitterSettingsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
